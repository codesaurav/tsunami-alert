package com.subtlyrude.tsunamialert;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String USGS_REQUEST_URL =
            "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2021-01-01&endtime=2021-12-01&minmagnitude=6";
    ...
    private void updateUi(Event earthquake) {
        ...
        TextView titleTextView = findViewById(R.id.event);
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                Log.e(LOG_TAG,"Problem retrieving the earth JSON results", e);
            } finally {
